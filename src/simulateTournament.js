...
function generateRandomResult(match) {
    ...
    while (player1Sets < requiredSets && player2Sets < requiredSets) {
    ...
    return {
        winnerId: player1Sets > player2Sets ? match.player1Id : match.player2Id,
        player1Sets,
        player2Sets,
        sets
    };
...
async function simulateTournament() {
    ...
    while (true) {
        ...
        console.log(
            `Spiel ${liveMatch.id}: ${liveMatch.player1Id} ${result.player1Sets}:${result.player2Sets} ${liveMatch.player2Id}`
        );
